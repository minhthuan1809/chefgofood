            ...
            <form onSubmit={handleSubmitEdit} className="space-y-4">
              <div>
                <input
                  ...
                  className="border-2 p-2 border-gray-300 mt-1 block w-full rounded-md shadow-sm focus:border-blue-600 focus:ring-blue-600"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="3"
                  className="border-2 p-2 mt-1 block w-full rounded-md shadow-sm focus:border-blue-600 focus:ring-blue-600"
                />
              </div>
